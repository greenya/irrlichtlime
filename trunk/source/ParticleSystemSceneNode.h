...
public:
	...
	ParticleBoxEmitter^ CreateBoxEmitter(AABBox^ box, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees, Dimension2Df^ minStartSize, Dimension2Df^ maxStartSize);
	ParticleBoxEmitter^ CreateBoxEmitter(AABBox^ box, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees);
	ParticleBoxEmitter^ CreateBoxEmitter(AABBox^ box, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax);
	ParticleBoxEmitter^ CreateBoxEmitter(AABBox^ box, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor);
	ParticleBoxEmitter^ CreateBoxEmitter(AABBox^ box, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond);
	...
	ParticleCylinderEmitter^ CreateCylinderEmitter(Vector3Df^ center, float radius, Vector3Df^ normal, float length, bool outlineOnly, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees);
	ParticleCylinderEmitter^ CreateCylinderEmitter(Vector3Df^ center, float radius, Vector3Df^ normal, float length, bool outlineOnly, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax);
	ParticleCylinderEmitter^ CreateCylinderEmitter(Vector3Df^ center, float radius, Vector3Df^ normal, float length, bool outlineOnly, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor);
	...
	ParticleMeshEmitter^ CreateMeshEmitter(Mesh^ particleMesh, bool useNormalDirection, Vector3Df^ direction, float normalDirectionModifier, int meshBufferIndex, bool everyMeshVertex, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees);
	ParticleMeshEmitter^ CreateMeshEmitter(Mesh^ particleMesh, bool useNormalDirection, Vector3Df^ direction, float normalDirectionModifier, int meshBufferIndex, bool everyMeshVertex, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax);
	ParticleMeshEmitter^ CreateMeshEmitter(Mesh^ particleMesh, bool useNormalDirection, Vector3Df^ direction, float normalDirectionModifier, int meshBufferIndex, bool everyMeshVertex, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor);
	...
	ParticleEmitter^ CreatePointEmitter(Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees, Dimension2Df^ minStartSize, Dimension2Df^ maxStartSize);
	ParticleEmitter^ CreatePointEmitter(Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees);
	ParticleEmitter^ CreatePointEmitter(Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax);
	ParticleEmitter^ CreatePointEmitter(Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor);
	...
	ParticleRingEmitter^ CreateRingEmitter(Vector3Df^ ringCenter, float ringRadius, float ringThickness, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees);
	ParticleRingEmitter^ CreateRingEmitter(Vector3Df^ ringCenter, float ringRadius, float ringThickness, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax);
	ParticleRingEmitter^ CreateRingEmitter(Vector3Df^ ringCenter, float ringRadius, float ringThickness, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor);
	...
	ParticleSphereEmitter^ CreateSphereEmitter(Vector3Df^ sphereCenter, float sphereRadius, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax, int maxAngleDegrees);
	ParticleSphereEmitter^ CreateSphereEmitter(Vector3Df^ sphereCenter, float sphereRadius, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor, unsigned int lifeTimeMin, unsigned int lifeTimeMax);
	ParticleSphereEmitter^ CreateSphereEmitter(Vector3Df^ sphereCenter, float sphereRadius, Vector3Df^ direction, unsigned int minParticlesPerSecond, unsigned int maxParticlesPerSecond, Video::Color^ minStartColor, Video::Color^ maxStartColor);
